...
After filtering, left 87 records for 2649 features


Wrote counts and metadata for raw counts All samples, no aggregation, no tests, only plots.After initial filtering to files [`data/1.1.1.4.1.1-32319c262e0samples.raw.16s.l.otu.count.tsv`](data/1.1.1.4.1.1-32319c262e0samples.raw.16s.l.otu.count.tsv),[`data/1.1.1.4.1.1-32319c262e0samples.raw.16s.l.otu.attr.tsv`](data/1.1.1.4.1.1-32319c262e0samples.raw.16s.l.otu.attr.tsv)


Wrote counts and metadata for proportions counts All samples, no aggregation, no tests, only plots.After initial filtering to files [`data/1.1.1.4.1.1-323352ee252samples.proportions.16s.l.otu.count.tsv`](data/1.1.1.4.1.1-323352ee252samples.proportions.16s.l.otu.count.tsv),[`data/1.1.1.4.1.1-323352ee252samples.proportions.16s.l.otu.attr.tsv`](data/1.1.1.4.1.1-323352ee252samples.proportions.16s.l.otu.attr.tsv)

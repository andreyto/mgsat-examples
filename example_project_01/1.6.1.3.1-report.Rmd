...
Wrote counts and metadata for raw counts Patient samples.After initial filtering to files [`data/1.6.1.3.1.1-32316183418samples.raw.16s.l.6.count.tsv`](data/1.6.1.3.1.1-32316183418samples.raw.16s.l.6.count.tsv),[`data/1.6.1.3.1.1-32316183418samples.raw.16s.l.6.attr.tsv`](data/1.6.1.3.1.1-32316183418samples.raw.16s.l.6.attr.tsv)


Wrote counts and metadata for proportions counts Patient samples.After initial filtering to files [`data/1.6.1.3.1.1-323681b1fe9samples.proportions.16s.l.6.count.tsv`](data/1.6.1.3.1.1-323681b1fe9samples.proportions.16s.l.6.count.tsv),[`data/1.6.1.3.1.1-323681b1fe9samples.proportions.16s.l.6.attr.tsv`](data/1.6.1.3.1.1-323681b1fe9samples.proportions.16s.l.6.attr.tsv)

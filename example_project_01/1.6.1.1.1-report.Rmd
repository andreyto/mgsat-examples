...
After filtering, left 67 records for 10 features


Wrote counts and metadata for raw counts Patient samples.After initial filtering to files [`data/1.6.1.1.1.1-3233aa024bdsamples.raw.16s.l.2.count.tsv`](data/1.6.1.1.1.1-3233aa024bdsamples.raw.16s.l.2.count.tsv),[`data/1.6.1.1.1.1-3233aa024bdsamples.raw.16s.l.2.attr.tsv`](data/1.6.1.1.1.1-3233aa024bdsamples.raw.16s.l.2.attr.tsv)


Wrote counts and metadata for proportions counts Patient samples.After initial filtering to files [`data/1.6.1.1.1.1-323532f1c62samples.proportions.16s.l.2.count.tsv`](data/1.6.1.1.1.1-323532f1c62samples.proportions.16s.l.2.count.tsv),[`data/1.6.1.1.1.1-323532f1c62samples.proportions.16s.l.2.attr.tsv`](data/1.6.1.1.1.1-323532f1c62samples.proportions.16s.l.2.attr.tsv)

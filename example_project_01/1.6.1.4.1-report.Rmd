...
After filtering, left 67 records for 2200 features


Wrote counts and metadata for raw counts Patient samples.After initial filtering to files [`data/1.6.1.4.1.1-3235c345689samples.raw.16s.l.otu.count.tsv`](data/1.6.1.4.1.1-3235c345689samples.raw.16s.l.otu.count.tsv),[`data/1.6.1.4.1.1-3235c345689samples.raw.16s.l.otu.attr.tsv`](data/1.6.1.4.1.1-3235c345689samples.raw.16s.l.otu.attr.tsv)


Wrote counts and metadata for proportions counts Patient samples.After initial filtering to files [`data/1.6.1.4.1.1-32345016738samples.proportions.16s.l.otu.count.tsv`](data/1.6.1.4.1.1-32345016738samples.proportions.16s.l.otu.count.tsv),[`data/1.6.1.4.1.1-32345016738samples.proportions.16s.l.otu.attr.tsv`](data/1.6.1.4.1.1-32345016738samples.proportions.16s.l.otu.attr.tsv)

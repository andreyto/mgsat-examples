...
Wrote counts and metadata for raw counts All samples, no aggregation, no tests, only plots.After initial filtering to files [`data/1.1.1.1.1.1-323c244280samples.raw.16s.l.2.count.tsv`](data/1.1.1.1.1.1-323c244280samples.raw.16s.l.2.count.tsv),[`data/1.1.1.1.1.1-323c244280samples.raw.16s.l.2.attr.tsv`](data/1.1.1.1.1.1-323c244280samples.raw.16s.l.2.attr.tsv)


Wrote counts and metadata for proportions counts All samples, no aggregation, no tests, only plots.After initial filtering to files [`data/1.1.1.1.1.1-3232680868samples.proportions.16s.l.2.count.tsv`](data/1.1.1.1.1.1-3232680868samples.proportions.16s.l.2.count.tsv),[`data/1.1.1.1.1.1-3232680868samples.proportions.16s.l.2.attr.tsv`](data/1.1.1.1.1.1-3232680868samples.proportions.16s.l.2.attr.tsv)

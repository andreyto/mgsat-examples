...
\(1.4.1.1.9.1\) <a name="figure.633"></a>[`Figure 633.`](#figure.633) Network analysis with method network.spiec.easi. Vertices are labeled by DESeq2 results for                          baseMean log2FoldChange     lfcSE       stat      pvalue        padj  i.baseMean      baseVar allZero dispGeneEst dispGeneIter. Showing names for the maximum of 30 top-ranked features.  Image file: [`plots/32353a48af7.svg`](plots/32353a48af7.svg).
![](plots/32353a48af7.svg)




\(1.4.1.1.9.1\) <a name="widget.170"></a>[`Widget 170.`](#widget.170) Network analysis with method network.spiec.easi. Vertices are labeled by DESeq2 results for                          baseMean log2FoldChange     lfcSE       stat      pvalue        padj  i.baseMean      baseVar allZero dispGeneEst dispGeneIter. Showing names for the maximum of 30 top-ranked features. Click to see HTML widget file in full window: [`./1.4.1.1.9.1-323ac6a00bNetwork.analysis.wit.html`](./1.4.1.1.9.1-323ac6a00bNetwork.analysis.wit.html)



<iframe src="./1.4.1.1.9.1-323ac6a00bNetwork.analysis.wit.html" width="800" height="800"> </iframe>